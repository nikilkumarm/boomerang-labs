        ...
        <main className="container">
          ...
          <header className="header">
            ...
            <div className="header-right">
              <a href="https://wa.me/442079460958" target="_blank" rel="noopener noreferrer" className="icon-btn" aria-label="WhatsApp">
              ...
              <Link href="/contact" className="contact-link-simple">
